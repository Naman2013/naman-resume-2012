...
const CONTRIBUTORS = [ // order matters
  ...
  },
  {
    ...
    photo: 'https://vega.slooh.com/assets/images/bookclub/headshots/Ballard.jpg',
  },
  {
    firstName: 'Ray',
    lastName: 'Bradbury',
    ...
    photo: 'https://vega.slooh.com/assets/images/bookclub/headshots/Bradbury.jpg',
  },
  {
    firstName: 'Don',
    lastName: 'DeLillo',
    ...
    photo: 'https://vega.slooh.com/assets/images/bookclub/headshots/Delillo.jpg',
  },
  {
    firstName: 'Phillip',
    lastName: 'Dick',
  ...
  },
  {
    ...
    photo: 'https://vega.slooh.com/assets/images/bookclub/headshots/Vonnegut.jpg',
  },
  {
    firstName: 'Virginia',
    lastName: 'Woolf',
...
class Description extends Component {
  ...
  render () {
    ...
    const modalProfilePhotoStyle = Object.assign(profilePhotoStyle(CONTRIBUTORS[contribIndex].photo), {
      width: '75px',
      height: '75px',
    });
    ...
    return (
      <main className="description-container">
        <h4 className="description-title">
          <b>THE SATURN ABOVE IT</b> &nbsp;&nbsp;| &nbsp;&nbsp; An Anthology of Short Fiction About Space
        </h4>
        <div className="description-main">
          <article className="description-leftpanel">
            <span dangerouslySetInnerHTML={{ __html: paragraphOne }} />
            <h4 className="description-title"><b>A note from the editor</b></h4>
        ...
        >
          ...
          <div className="modal-person-detail">
            <div className="profile-photo" key={CONTRIBUTORS[contribIndex].name} style={modalProfilePhotoStyle}></div>
            <h4 className="modal-username">
              <div>{CONTRIBUTORS[contribIndex].firstName}</div>
              <div>{CONTRIBUTORS[contribIndex].lastName}</div>
              </h4>
            </div>
          <p className="modal-bio" dangerouslySetInnerHTML={{ __html: CONTRIBUTORS[contribIndex].bio }} />
        </Modal>
        <style jsx>{`
