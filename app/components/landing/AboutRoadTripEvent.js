        ...
        <div className={style.inner}>
          <div className={style.leftSide}>
            ...
            <div className={style.description}>
              <p>In years past, Slooh has traveled around the world - to Kenya, the Faroe Islands, and Indonesia - to bring our community of space enthusiasts live views of total solar eclipses. This year is no different. We’re packing up the Space Situation Room and heading to the Rocky Mountain Ranch in Stanley, Idaho, one of the first towns situated directly in the path of totality. From there we’ll be using some of the most advanced equipment available to bring you up-close views of the eclipse live as it happens, with commentary and perspective from the world’s leading experts in solar eclipses.</p>
