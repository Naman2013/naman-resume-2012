...
import {
  SAMPLE_IMAGE_HTML_BLOB,
  SAMPLE_VIDEO_HTML_BLOB,
} from '../../../stories/content/getGuidesPanels';
...
describe('GuideTopics', () => {
  const props = {
    list: [
      ...
      {
        title: 'Mars',
        iconURL: 'https://vega.slooh.com/icons/home/jupiter-icon.png',
      },
    ],
  };
