...
import { fetchInvitePopupContent, fetchGroupInvitationPanel, addExistingUser, addGoogleUser, fetechRestoreMember, fetchArchiveMember, fetchBuyMember, fetchGoogleClassroomStudentsPanel } from '../../../../app/modules/community-group-overview/actions';
...
class FullInformationOverview extends Component {
  ...
  componentDidMount() {
    const { isGoogleClassroom, canEditGroup, discussionGroupId, actions } = this.props;
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.isGoogleClassroom !== prevState.isGoogleClassroom) {
      const { isGoogleClassroom, canEditGroup, discussionGroupId, actions } = this.props;
        ...
        <GroupsContainer
          ...
          newMember={
            <>
              ...
              ></div>
              <Members
                list={canEditGroup || isGoogleClassroom ? customerLinks : membersList}
                discussionGroupId={discussionGroupId}
