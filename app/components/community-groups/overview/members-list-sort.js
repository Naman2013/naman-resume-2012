...
const GroupMemberListSort = ({
  ...
  <div className="">
    <div className="sort-button-container">
      <a
        onClick={() =>
          fetchGroupMembers({ discussionGroupId, sortBy: SORT_AZ })
        }
      ...
      <a
        onClick={() =>
          fetchGroupMembers({ discussionGroupId, sortBy: SORT_ZA })
        }
        className={classnames('sort-button', {
      ...
      <a
        onClick={() =>
          fetchGroupMembers({ discussionGroupId, sortBy: SORT_RANK })
        }
        className={classnames('sort-button', {
