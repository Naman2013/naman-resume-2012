...
export function destroySession() {
  ...
  window.document.cookie = cookie.serialize('cid', '', { domain: 'localhost', expires: new Date('Thu, 01 Jan 1970 00:00:01 GMT'), path: COOKIE_PATH });
  window.document.cookie = cookie.serialize('token', '', { domain: 'localhost', expires: new Date('Thu, 01 Jan 1970 00:00:01 GMT'), path: COOKIE_PATH });
  window.document.cookie = cookie.serialize('at', '', { domain: 'localhost', expires: new Date('Thu, 01 Jan 1970 00:00:01 GMT'), path: COOKIE_PATH });
  window.document.cookie = cookie.serialize('fname', '', { domain: 'localhost', expires: new Date('Thu, 01 Jan 1970 00:00:01 GMT'), path: COOKIE_PATH });
}
