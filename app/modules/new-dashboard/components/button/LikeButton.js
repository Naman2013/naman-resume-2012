...
import { handleLikeReq } from '../../dashboardApi';
...
class LikeButton extends Component {
  ...
  filledHeartIcon = 'https://vega.slooh.com/assets/v4/dashboard-new/heart.svg';
  heartIcon = 'https://vega.slooh.com/assets/v4/dashboard-new/heart_grey.svg';
  render() {
    const {
      likePrompt,
      likesCount,      
    ...
    const { mod, user, likedByMe, likeTooltip, btnStyle, } = this.props;
    if (!user) return null;
      ...
      <Fragment>
        ...
        >
          ...
          <Button
              ...
              text={likesCount}                                             
              style={btnStyle}
              icon={(likedByMe || likedByMeInner) ? this.filledHeartIcon : this.heartIcon}
          />
