      ...
      totalPageCount > 1 && (
        <div className="pagination-root">
          <ul className="buttons">
            <li className="button">
              <span className="text-size active" onClick={this.handleFirstPage}>{"First"}</span>
              {/* <GenericButton
            ...
            <li className="button">
            <img onClick={this.handlePrevPage} className="rotate-180" src="https://vega.slooh.com/assets/v4/dashboard-new/right_arrow_white.svg"/>
            {/* <h1 onClick={this.handlePrevPage}>{"<"}</h1> */}
              {/* <GenericButton
          ...
          <ul className="buttons">
            <li className="button">
              <img onClick={this.handleNextPage} src="https://vega.slooh.com/assets/v4/dashboard-new/right_arrow_white.svg"/>
              {/* <h1 onClick={this.handleNextPage}>{">"}</h1> */}
              {/* <GenericButton
            ...
            <li className="button">
              <span className="text-size active" onClick={this.handleLastPage}>{"Last"}</span>
              {/* <GenericButton
                theme={lastPageStyle}
                text="Last"
