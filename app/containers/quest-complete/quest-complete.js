      ...
      <div className="inner-center">
        <CenterColumn>
          <div className="inner-center-intro">
            <span
              ...
              dangerouslySetInnerHTML={{
                __html: complete.congratulationsCaption,
              }}
            />
            <span
              className="quest-completed"
              dangerouslySetInnerHTML={{ __html: complete.questCompletedTitle }}
            />
          </div>
          <div className="inner-container">
            <div className="top-shield-container">
              ...
              <div className="top-icon-container">
                <img
                  className="top-icon-content"
                  alt=""
                  width="40"
                  height="40"
                  src={complete.stepIconURL}
                />
              </div>
            </div>
            <div className="content-container">
              ...
              <div className="step-list">
                {complete.stepList.map(step => (
                  <div className="step">
                    <div>{step.stepFullTitle}</div>
                    <img
                      className="check-icon"
                      src={step.stepIconURL}
                      alt="incompleted icon"
                    />
                  </div>
                ))}
              </div>
              <div className="did-you-know">
                <div className="did-you-know-caption">
                  {complete.didYouKnowCaption}
                </div>
          ...
          <div className="more-quests-container">
            <div className="more-quests-caption">
              {complete.relatedQuestsCaption}
            </div>
            {complete.relatedQuestsList.map(tile => (
              <div className="more-quests-tile">
                <QuestTile
