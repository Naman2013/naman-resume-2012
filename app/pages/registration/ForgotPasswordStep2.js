/** *********************************
* V4 Join - Forgot Password - Complete
********************************** */
...
export default connect(mapStateToProps, null)(reduxForm({ form: 'schoolDistrictForm', enableReinitialize: true, })(ForgotPasswordStep2));
